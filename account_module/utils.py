...
def send_otp_code(otp_code, email_address, phone_number):
    ...
    if email_address:
        ...
        if success_count == 1:
            ...
            is_sent = True
            message = 'the activation code has been successfully sent to your email'
        elif success_count == 0:
            otp_code.is_used = False
            is_sent = False
            message = 'the activation code has not been sent successfully'
    ...
    if phone_number:
        ...
        if result:
            otp_code.is_used = True
            is_sent = True
            message = 'the activation code has been successfully sent as a text message to your phone'
        else:
            is_sent = False
            message = 'the activation code has not been sent successfully'
